      ...
      <div className="w-full px-3.5 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center justify-start shrink-0">
          <button
            ...
            className="slide-btn slide-btn-slate p-1.5 sm:p-2 rounded-full flex items-center justify-center shrink-0 group active:scale-95 transition-transform"
        ...
        <div className="flex items-center gap-1 sm:gap-3 lg:gap-4 shrink-0 min-w-0">
          ...
          {currentUser && (
            <div className="flex items-center gap-2 sm:gap-4 px-1 py-1 sm:px-2 sm:py-1.5 bg-slate-100/60 dark:bg-zinc-900/60 rounded-[8px] border border-slate-200/50 dark:border-zinc-800/50 min-w-0 shrink-0">
              ...
              <button
                onClick={onLogout}
                className="slide-btn slide-btn-red p-1.5 sm:px-3.5 sm:py-1.5 rounded-full font-bold text-[9px] sm:text-[11px] flex items-center justify-center gap-1 shrink-0"
                title="Sign out"
              >
                <span className="relative z-10 flex items-center justify-center gap-1.5">
